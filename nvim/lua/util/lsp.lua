...
function M.formatter(opts)
  ...
  local ret = {
    ...
    priority = 1,
    format = function(buf)
      M.format(require("util").merge({}, filter, { bufnr = buf }))
    end,
    sources = function(buf)
      local clients = M.get_clients(require("util").merge({}, filter, { bufnr = buf }))
  ...
  return require("util").merge(ret, opts) --[[@as Formatter]]
end
